...
namespace LotGD\Module\Res\Form\Tests;
...
use LotGD\Module\Res\Form\Module;
...
class ModuleTest extends ModuleTestCase
{
    ...
    public function testIfModuleIsCorrectlySubscribedToEvent()
    {
        $context = new \LotGD\Core\Events\EventContext(
            "h/lotgd/crate/html/displayScene/renderAttachment/" . FormAttachment::class,
            "none",
            \LotGD\Core\Events\EventContextData::create([
                "attachment" => new FormAttachment($this->g, new Scene("a", "b")),
                "renderedAttachment" => [],
            ])
        );
